 ...
 * @Description
 **/
public class FrontListMethodHtmlBuilder extends BaseCodeBuilder {
    private ConfigParam config;
    private String tableName;
    private String title;

    public FrontListMethodHtmlBuilder(JdbcTbDao jdbcDao, CommEvent<String> logEvent, ConfigParam config, String tableName, String title) {
    ...
    protected String getFileName() {
        ...
        return getCodeFilePath(config.getCodeBuilder().getFrontPath(), modelCode) + "/list/methods.html";
    }

    @Override
    protected String getCode(Map<String, String> map) {
        String result = ConfigUtils.loadResFile("/front-code-template/list/methods.html");
