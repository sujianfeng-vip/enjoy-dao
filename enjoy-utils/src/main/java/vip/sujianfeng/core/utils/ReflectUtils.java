package vip.sujianfeng.core.utils;
...
public class ReflectUtils {
	...
	public static Object getFieldValue(Object obj, String field) throws IllegalAccessException {
		Field f = getDeclaredField(obj.getClass(), field);
		//Assert.assertNotNull( obj.getClass().getName() + "不存在属性：" + field, f);
		f.setAccessible(true);
		return f.get(obj);
	}

	public static void setFieldValue(Object obj, String field, Object value) throws IllegalAccessException {
		Field f = getDeclaredField(obj.getClass(), field);
		//Assert.assertNotNull(obj.getClass().getName() + "不存在属性：" + field, f);
		f.setAccessible(true);
		f.set(obj, value);
